...
# Load reference data for scaling and exclude 'Price' and 'Id' columns
reference_data = pd.read_csv("preprocessing/ED.csv", index_col=0).drop(columns=["Price", "Id"])
...
if st.button("Predict"):
    ...
    normalized_manual_data = normalize_data(manual_data, reference_data)
